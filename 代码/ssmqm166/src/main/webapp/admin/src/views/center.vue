  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="身高" prop="shengao">
          <el-input v-model="ruleForm.shengao"               placeholder="身高" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="体重" prop="tizhong">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='jiaolian'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaolian'"  label="手机号" prop="shoujihao">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'xueyuan' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
      ...
      if( 'jiaolian' ==this.flag && this.ruleForm.shoujihao&&(!isMobile(this.ruleForm.shoujihao))){
        this.$message.error(`手机号应输入手机格式`);
        return
      }
      if( 'jiaolian' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
        this.$message.error(`余额应输入数字`);
        return
      }
