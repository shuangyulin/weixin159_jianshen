    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="教练姓名" prop="jiaolianxingming">
          <el-select  @change="jiaolianxingmingChange" v-model="ruleForm.jiaolianxingming" placeholder="请选择教练姓名">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiaolianxingming" label="教练姓名" prop="jiaolianxingming">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="个人介绍" prop="gerenjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gerenjieshao" label="个人介绍" prop="gerenjieshao">
                    <span>{{ruleForm.gerenjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    // 下二随
    jiaolianxingmingChange () {
      this.$http({
        url: `follow/jiaolian/jiaolianxingming?columnValue=`+ this.ruleForm.jiaolianxingming,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
